...
function makeTestmonialsSliderInfo(data) {
...
function makeTestmonialsSliderControl(direction) {
  const container = makeElement('div', `slider__${direction}`);

  const arrow = makeElement('div', `${direction}`);
